...
class TianJinSpider(scrapy.Spider):
    name = "tianjin"
    base_url = "http://zm.tj.gov.cn/gov_open/question/zero/list8a.jsp?curpage={}&rows=15&deptId=1001000000000000"
    ...
    def parse_list(self, response):
        ...
        for info in lines:
            ...
            id = re.search(u"_xianqing/\?id=(\d+)", item[u"链接"]).group(1)
